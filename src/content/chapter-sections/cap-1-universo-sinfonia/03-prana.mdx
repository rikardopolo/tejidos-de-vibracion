...
La alternancia de fosas nasales no es ritual: tiene base anatómica. Ambas fosas reciben inervación simpática y parasimpática; lo que cambia a lo largo del día es cuál de las dos está bajo mayor tono simpático — la vasoconstricción la vuelve más permeable mientras la otra se congestiona—, y por eso la dominancia se alterna en lugar de estar asignada de antemano. Alternar deliberadamente entre ambas durante varios minutos modula el equilibrio autonómico: en veintiséis voluntarios la frecuencia respiratoria descendió y la variabilidad de la frecuencia cardíaca aumentó, lo que sugiere un incremento de la actividad vagal *(Telles, Sharma & Balkrishna, 2014)*. Un trabajo anterior del mismo grupo había medido el descenso de la tensión arterial en personas con hipertensión, sin registrar variables autonómicas *(Telles et al., 2013)*.
