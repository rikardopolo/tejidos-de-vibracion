...
Las dos estrategias que has recorrido operan con principios opuestos: las catedrales góticas envuelven al fiel en sonido sostenido; los templos jemeres conducen al peregrino al silencio progresivo. ¿Por qué dos tradiciones sin contacto entre sí llegaron a soluciones acústicas opuestas para el mismo tipo de recogimiento? ¿Qué dice eso sobre la naturaleza de lo "sagrado" en relación con el sonido?
...
¿Cambia tu manera de elegir y habitar espacios saber cuánto difieren acústicamente unos de otros — y que a ti te pasa algo distinto en cada uno, aunque nadie haya medido todavía el qué? ¿Hay decisiones de diseño en tu vida cotidiana que reconsiderarías sabiéndolo?
