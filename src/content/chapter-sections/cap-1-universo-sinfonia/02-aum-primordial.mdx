...
*1901 — 1976 · Físico teórico, primer eco filosófico de lo que el Cap. 3 desplegará*
...
No necesitas creer nada metafísico para que el ejercicio actúe. Vocalizar exhalaciones prolongadas activa el nervio vago y dispara una respuesta parasimpática inmediata *(Porges, 2011)*. Un estudio piloto de resonancia magnética funcional con doce voluntarios encontró **desactivación** de las regiones límbicas —amígdala derecha, hipocampos, cingulado anterior— durante el canto sostenido de OM, y ninguna activación significativa *(Kalyani et al., 2011)*. Doce personas y una sola muestra: es una pista, no un resultado asentado.
