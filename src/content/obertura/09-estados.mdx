...
<h2 id="sec-cap-8" class="chapter"><span class="num">09</span>Sobre los Estados Expandidos de Consciencia y la Autohipnosis Cuántica</h2>
...
La sección §9.1 explica este uso. La sección §9.4 establece la regla inquebrantable: el Meta-Observador se instala primero, sin excepción, antes de cualquier estado expandido.

Si saltas a §9.5 sin haber leído §9.4, vuelve atrás antes de proceder.
...
<h3 class="sub"><span class="num">9.1</span>Qué significa aquí «cuántica»</h3>
...
<h3 class="sub"><span class="num">9.2</span>Carril A: Qué dice la neurociencia sobre estos estados</h3>
...
<h3 class="sub"><span class="num">9.3</span>Carril A complementario: Efecto placebo y modulación de la fisiología por expectativa</h3>
...
<h3 class="sub"><span class="num">9.4</span>Advertencia obligatoria: higiene contemplativa</h3>
...
<h3 class="sub"><span class="num">9.5</span>Protocolo de interrupción y señales de alerta</h3>
