...
<FiguraEditorial
  src="/assets/cap-1/figura-1-8.png"
  numero="1.8"
  titulo="Las seis frecuencias del solfegio Puleo · escala visual con etimología litúrgica"
