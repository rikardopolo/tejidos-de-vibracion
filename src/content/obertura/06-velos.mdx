...
<h2 id="sec-cap-5" class="chapter"><span class="num">Capítulo 5</span>Los Tres Velos de Lectura</h2>

<h3 class="sub"><span class="num">5.1</span>Un libro que se toca de tres maneras</h3>
...
<h3 class="sub"><span class="num">5.2</span>Cómo leer</h3>
