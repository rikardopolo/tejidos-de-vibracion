...
<PausaCientifica title="Estados θ y Ventanas de Neuroplasticidad" level={1}>

Durante meditación profunda, autohipnosis o estados hipnagógicos (transición vigilia-sueño), el electroencefalograma muestra un incremento significativo de ondas theta (4-8 Hz), particularmente en regiones frontales y temporales. Estos estados se asocian con:
...
Los estados theta aumentan la sugestionabilidad. Esto es un hecho neurobiológico, no una opinión.

Durante estos estados, las defensas críticas ordinarias se relajan, y los contenidos que ingresan a la consciencia pueden integrarse a niveles más profundos que los del estado de vigilia habitual. Esta propiedad es lo que vuelve útiles a estos estados para integrar marcos beneficiosos: meditaciones compasivas, visualizaciones de salud, reconfiguración de patrones auto-limitantes.

Pero es exactamente la misma propiedad que los vuelve peligrosos si se entra en ellos bajo la guía de contenido manipulativo, dogmático o no examinado. Por eso este libro establece una regla inquebrantable para toda práctica de autohipnosis cuántica o equivalente que proponga:

**El Meta-Observador se instala primero. Siempre. Sin excepción.**

Antes de cualquier ejercicio que induzca estados expandidos, se activa deliberadamente la consciencia que observa. Esa consciencia permanece como testigo durante todo el proceso. Es el único anclaje confiable. No se entra a un estado sugestible sin él.
