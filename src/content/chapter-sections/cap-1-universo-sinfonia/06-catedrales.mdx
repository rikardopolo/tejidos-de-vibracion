...
<FiguraTDV
  ...
  descripcion="Las cinco arquitecturas que recoge esta lámina, de las seis que recorre la sección: falta Reims. Notre-Dame y Chartres operan con la estrategia occidental, envolver en sonido sostenido mediante una reverberación larga, por encima de cuatro segundos. Borobudur y Angkor Wat operan con la asiática: conducir al peregrino por gradientes acústicos hacia el silencio, en un recorrido que en Borobudur es ascendente y termina al aire libre, no en una cámara interior. La Gran Pirámide de Giza es un caso intermedio: su Cámara del Rey tiene modos resonantes propios. Que esas propiedades acústicas estén medidas no significa que se sepa qué le hacen al cuerpo de quien las habita, ni que sus constructores las buscaran: son tres afirmaciones distintas y la sección las separa expresamente."
/>
