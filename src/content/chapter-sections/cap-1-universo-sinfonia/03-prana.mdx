...
num: "1.2"
title: "Prana"
subtitle: "Lo que la tradición védica vio en el aliento mucho antes que la fisiología"
order: 4
...
<h4 class="sub-sub">Mapa rápido de diez términos sánscritos en una página</h4>
...
<h3 class="sub">¿Qué tipo de cosa es Prana?</h3>
...
<h4 class="sub-sub">Hipótesis A: Prana = aire físico (oxígeno)</h4>
...
<h4 class="sub-sub">Hipótesis B: Prana = sistema nervioso autónomo</h4>
...
<h4 class="sub-sub">Hipótesis C: Prana = biocampo electromagnético</h4>
...
<h4 class="sub-sub">Hipótesis D: Prana = constructo fenomenológico</h4>
...
<h4 class="sub-sub">Cuatro capas, no cuatro rivales</h4>
...
De las cuatro hipótesis que has recorrido en esta sección, ¿cuál te resulta más sostenible epistemológicamente? ¿Por qué? Una respuesta honesta puede incluir *«sostengo varias en paralelo»* o *«ninguna me convence completamente»*.
