...
subtitle: "Los mismos párrafos, leídos de tres maneras a la vez"
section: "marco"
order: 9
...
<h4 class="sub-sub">Primer Velo: la información</h4>
...
<h4 class="sub-sub">Segundo Velo: la encarnación</h4>
...
<h4 class="sub-sub">Tercer Velo: el reconocimiento</h4>
